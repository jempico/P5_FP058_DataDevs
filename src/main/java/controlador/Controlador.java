...
public class Controlador {
    ...
    public List<Cliente> mostrarClientesEstandar() { return datos.mostrarClientesEstandar(); }

    public List<Cliente> mostrarClientesPremium() { return datos.mostrarClientesPremium(); }
