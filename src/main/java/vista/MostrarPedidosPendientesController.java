...
public class MostrarPedidosPendientesController implements Initializable {
    ...
    private void cargarDatos() {
        ...
        try {
            ...
            System.out.println(listaDePedidosPendientes);
            // Agregar datos a la tabla
            tableViewPedidos.getItems().addAll(listaDePedidosPendientes);
            this.mostrarPedidosPendientes(listaDePedidosPendientes);
        } catch (Exception e) {
            e.printStackTrace();
            // Manejar la excepción apropiadamente en tu aplicación
        }
    }
    public void mostrarPedidosPendientes(List<Pedido> listaDePedidos) {
