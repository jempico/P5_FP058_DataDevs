...
public class MostrarClientesPremiumController implements Initializable {
    ...
    private void cargarDatos() {
        ...
        try {
            List<Cliente> listaDeClientes = controlador.mostrarClientesPremium();
            // Agregar datos a la tabla
            tableViewClientes.getItems().addAll(listaDeClientes);
            this.mostrarClientesPremium(listaDeClientes);
        } catch (Exception e) {
            e.printStackTrace();
            // Manejar la excepción apropiadamente en tu aplicación
        }
    }
    public void mostrarClientesPremium(List<Cliente> listaDeClientes) {
